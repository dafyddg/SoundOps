...
plt.plot(window)
plt.title("Hann (von Hann, Hanning, cosine) window",fontsize=fontsize)
...
plt.savefig(localdirectory+'hanning01.png')
plt.close('all')
...
print '<img src=\"'+webdirectory+'hanning01.png\" width=\"100%\">'
print '<img src=\"'+webdirectory+'hanning02.png\" width=\"100%\">'
