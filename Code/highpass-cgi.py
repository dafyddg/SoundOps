...
def inithtml():
    ...
    print '<html><head><title>High pass filter</title>'
    print """
    <style type="text/css">
        tdp {font-size:14}
        td {font-size:14}
...
plt.xscale('log')
plt.title('Butterworth high pass filter frequency response',fontsize=fontsize)
...
plt.savefig(localdirectory+'highpass.png')


inithtml()

print '<img src=\"'+webdirectory+'highpass.png\" width=\"100%\">'
